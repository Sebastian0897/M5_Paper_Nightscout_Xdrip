...
M5EPD_Canvas canvas(&M5.EPD); // setup fpr the Display
...
String url = "https://MYSERVERADRESSFORNIGHTSCOUT/api/v1/entries.json?count=5"; //Blood glucose values from Nightscout. Gets the last 5 Values. currently only using the most recent.
String line; //
...
*/
canvas.pushCanvas(300,300,UPDATE_MODE_GC16);
}
